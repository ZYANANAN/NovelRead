...
const char kControlStateObserverKey;

- (void)handStateChangeWithBlock:(void(^)())block
{
    ...
    [self addObserver:self forKeyPath:@"highlighted" options:(NSKeyValueObservingOptionNew | NSKeyValueObservingOptionOld) context:nil];
    objc_setAssociatedObject(self, &kControlStateObserverKey, block, OBJC_ASSOCIATION_RETAIN);
}

- (void)observeValueForKeyPath:(NSString *)keyPath ofObject:(id)object change:(NSDictionary *)change context:(void *)context
{
    void (^block)() = objc_getAssociatedObject(self,&kControlStateObserverKey);
    if (block) {
        block();
    }
}
